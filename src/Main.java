...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n>>> RELATÓRIO DIÁRIO DE OCUPAÇÃO (" + String.valueOf(hoje) + ") <<<");
        System.out.println("===========================================================================");
        ...
        for(Enfermaria e : hospital.getEnfermarias()) {
            ...
            System.out.printf("%-5s | %-15s | %6.1f%%    | %-12s | %6.1f dias\n", e.getId(), e.getClass().getSimpleName().replace("Enfermaria", ""), e.taxaOcupacao(hoje), estado, e.mediaLoS());
        }

        PrintStream var10000 = System.out;
        String var10001 = String.valueOf(inicioRelatorio);
        var10000.println("\n>>> ANÁLISE DE PERFORMANCE (Período: " + var10001 + " a " + String.valueOf(fimRelatorio) + ") <<<");
        System.out.println("===========================================================================");
